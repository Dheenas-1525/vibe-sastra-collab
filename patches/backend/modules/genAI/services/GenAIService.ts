...
// Rewrite internal Docker GCS URLs to externally accessible URLs for the browser.
// GCS_INTERNAL_URL e.g. "http://fake-gcs:4443"  (only reachable inside Docker)
// GCS_EXTERNAL_URL e.g. "http://localhost:4443"  (reachable from the browser)
...
export class GenAIService extends BaseService {
  ...
  async getTaskStatus(
    ...
    return this._withTransaction(async session => {
      ...
      // Rewrite internal Docker GCS hostnames to browser-accessible URLs.
